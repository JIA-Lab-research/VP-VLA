...
DATASET_NAMED_MIXTURES = {
    ...
    "smartmore_franka_filter_class_12": [
        ("filter_class_1_lerobot", 1.0, "smartmore_franka_vp"),
        ("filter_class_2_lerobot", 1.0, "smartmore_franka_vp"),
    ],
    "smartmore_franka_move_egg": [
        ("move_egg_lerobot", 1.0, "smartmore_franka_vp_move_egg"),
    ],
    "smartmore_franka_sweep_floor": [
        ("sweep_floor_lerobot", 1.0, "smartmore_franka_vp"),
    ],
    "smartmore_franka_pick_color_egg": [
        ("pick_color_egg_lerobot", 1.0, "smartmore_franka_vp"),
    ],
