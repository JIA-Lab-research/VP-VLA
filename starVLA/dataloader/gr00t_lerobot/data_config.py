...
class SmartmoreFrankaVPDataConfig:
    video_keys = [
        "video.external_upper_camera",
        "video.wrist_image",
    ]
    state_keys = [
        "state.joints",
...
class SmartmoreFrankaVPMoveEggDataConfig(SmartmoreFrankaVPDataConfig):
    video_keys = [
        "video.center_up_camera",
        "video.wrist_image",
    ]
...
ROBOT_TYPE_CONFIG_MAP = {
    ...
    "smartmore_franka_vp": SmartmoreFrankaVPDataConfig(),
    "smartmore_franka_vp_move_egg": SmartmoreFrankaVPMoveEggDataConfig(),
}
