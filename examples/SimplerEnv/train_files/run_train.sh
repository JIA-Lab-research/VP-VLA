#!/bin/bash
# VP-VLA Training Script for SimplerEnv (OXE datasets)
...
visual_prompt_dir=./playground/Datasets/visual_prompt_simplerenv
extracted_frames_dir=./playground/Datasets/extracted_frames_simplerenv
data_mix=bridge_rt_1_vp

# Output
run_root_dir=./playground/Checkpoints
run_id=oxe_${data_mix}_visual_prompt_training_${Framework_name}
...
accelerate launch \
  ...
  --config_yaml ./examples/SimplerEnv/train_files/starvla_cotrain_oxe_visual_prompt.yaml \
  ...
  --run_id ${run_id} \
  --wandb_project starVLA_simplerEnv_visual_prompt \
